...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen pb-24" style={{ background: "#f0f7f0" }}>
      {/* HERO */}
      <div
        className="px-5 pt-12 pb-8 rounded-b-[40px] shadow-lg"
        style={{
      ...
      >
        ...
        <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-3xl p-5 mt-2">
          ...
          <p className="text-green-200 text-sm mb-5">
            Temukan campaign terbaik dengan bantuan AI
          </p>
      ...
      <div className="px-5 mt-6">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/campaign" className="text-green-600 text-xs font-bold">
            Lihat semua →
          </Link>
        </div>
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="mt-2">
                          ...
                          <p className="text-gray-400 text-xs mt-1">
                            Target: Rp {c.targetAmount.toLocaleString("id-ID")}
                          </p>
                        </div>
                      </div>
                    </div>
      ...
      <div className="px-5 mt-5">
        <Link href="/ai">
          <div
            className="rounded-3xl p-5 flex items-center justify-between active:scale-[0.98] transition-all shadow-md"
            style={{ background: "linear-gradient(135deg, #16a34a, #15803d)" }}
          >
            <div>
              <p className="text-white font-bold text-sm">
                Bingung mau donasi apa? 🤖
              </p>
              <p className="text-green-200 text-xs mt-0.5">
                Tanya Donyar AI sekarang
              </p>
            </div>
