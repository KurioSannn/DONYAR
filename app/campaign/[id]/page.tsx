...
export default async function CampaignDetail({
      ...
      >
        <div className="text-center">
          ...
          <p className="text-gray-400 text-sm mt-1">
            Campaign sudah berakhir atau tidak ada.
          </p>
        </div>
      </main>
    );
  ...
  return (
    <main className="min-h-screen pb-32" style={{ background: "#f0f7f0" }}>
      {/* HERO */}
      <div
        className="px-5 pt-12 pb-24 rounded-b-[48px] shadow-xl relative overflow-hidden"
        style={{
      ...
      >
        ...
        <div
          className="relative w-16 h-16 rounded-3xl flex items-center justify-center text-3xl mb-4 shadow-lg"
          style={{
        ...
        <h1 className="relative text-white font-bold text-2xl leading-tight mb-2">
          {campaign.title}
        </h1>
        <p className="relative text-green-100 text-sm leading-relaxed">
